...
set(gcf,'pos',[0 250 200 200]);
axis('equal');
set(gca,'xlim',lx,'ylim',ly);
    
xlabel(['X [', munit,']'],'FontName', 'Times New Roman');
ylabel(['Y [', munit,']'],'FontName', 'Times New Roman');
...
%     plot_onetraj(tset.traj{trial},cols,target_angles)
    %if tset.targetno(trial)==2
       ...
       plot_trajforce(tset.traj{trial},cols);
